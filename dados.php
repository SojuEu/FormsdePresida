...
<body class="py-4 fundo-aguia">
  <div class="container" style="max-width: 780px;">
    ...
    if ($data_nasc) {
      ...
      $data_nasc_formatada = $nasc->format('d/m/Y');
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <p class="info-value"><?= $data_nasc_formatada ?> <?= $idade ? "($idade)" : '' ?></p>
          </div>
          <div class="col-md-6">
          ...
          <!-- DEPOIS -->
          <div class="col-12">
            <p class="info-label mb-1">Foto Enviada</p>
            <?php if ($foto_src): ?>
              <img src="<?= $foto_src ?>" alt="Foto de <?= $nome ?>" class="rounded shadow-sm"
                style="max-width: 50%; max-height: auto; object-fit: cover;">
            <?php else: ?>
              <span class="text-muted small">Nenhuma foto enviada.</span>
            <?php endif; ?>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <p class="info-value"><?= $anos_residencia ? $anos_residencia . ' anos' : '—' ?></p>
          </div>
          <div class="col-md-6">
      ...
      <div class="card-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <span class="stars"><?= $autopreparo ? $estrelas : '—' ?></span>
            <?php if ($autopreparo): ?>
              <span class="text-muted small ms-1">(<?= $autopreparo ?>/5)</span>
            <?php endif; ?>
          </div>
          <div class="col-12">
