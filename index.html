...
<html lang="pt-BR">
  <head>
    ...
    <style>
      ...
      .fundo-aguia {
        background-image: url("./img/fundo-aguia.png");
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Estado natal <span class="text-danger">*</span></label
                >
                <select class="form-select" name="estado_natal" required>
                  <option value="">Selecione...</option>
                  <?php foreach
                  (['Alabama','Alaska','Arizona','Arkansas','California','Colorado','Connecticut','Delaware','Florida','Georgia','Hawaii','Idaho','Illinois','Indiana','Iowa','Kansas','Kentucky','Louisiana','Maine','Maryland','Massachusetts','Michigan','Minnesota','Mississippi','Missouri','Montana','Nebraska','Nevada','New
                  Hampshire','New Jersey','New Mexico','New York','North
                  Carolina','North
                  Dakota','Ohio','Oklahoma','Oregon','Pennsylvania','Rhode
                  Island','South Carolina','South
                  Dakota','Tennessee','Texas','Utah','Vermont','Virginia','Washington','West
                  Virginia','Wisconsin','Wyoming'] as $e): ?>
                  <option><?= $e ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >E-mail de contato <span class="text-danger">*</span></label
                >
                <input
                  type="email"
                  class="form-control"
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Anos não sendo imigrante nos EUA
                  <span class="text-danger">*</span></label
                >
                <input
                  type="number"
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Último cargo (se houver)</label
                >
                <input
                  type="text"
                  class="form-control"
                  name="ultimo_cargo"
                  placeholder="Ex: Senador, Governador..."
                />
              </div>
            </div>
          </div>
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Filiação partidária <span class="text-danger">*</span></label
                >
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Slogan de campanha <span class="text-danger">*</span></label
                >
                <input
                  type="text"
                  class="form-control"
              ...
              <div class="col-12">
                <label class="form-label fw-semibold"
                  >Principais áreas de foco (marque até 3)</label
                >
                <div class="row g-2 mt-1">
                  <?php foreach (['Economia','Saúde dos legítimos
                  americanos','Educação','Defesa Nacional contra
                  imigrantes','Meio Ambiente','Imigração de
                  mexicanos','Tecnologia (menos a da China)','Direitos Civis dos
                  legítimos americanos brancos'] as $area): ?>
              ...
              <div class="col-12">
                <label class="form-label fw-semibold"
                  >Proposta principal de governo
                  <span class="text-danger">*</span></label
                >
                <textarea
                  class="form-control"
                  name="proposta_principal"
                  rows="4"
                  required
                  placeholder="Descreva sua principal proposta em até 200 palavras..."
                ></textarea>
              </div>
            </div>
          </div>
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Formação acadêmica <span class="text-danger">*</span></label
                >
              ...
              <div class="col-12">
                ...
                <textarea
                  ...
                  rows="3"
                  required
                  placeholder="Liste cargos, se já expulsou algum mexicano..."
                ></textarea>
              </div>
              <div class="col-12">
                <label class="form-label fw-semibold"
                  >Como avalia seu preparo para o cargo? (1–5)</label
                >
                <div class="d-flex gap-3 mt-1">
                  ...
                  <div class="form-check">
                    <input
                      ...
                      id="ap_<?= $i ?>"
                    />
                    <label class="form-check-label" for="ap_<?= $i ?>"
                      ><?= $i ?></label
                    >
                  </div>
                  <?php endfor; ?>
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="row g-3">
              <div class="col-12">
                ...
                <div class="form-check mb-2">
                  <input
                    class="form-check-input"
                    type="checkbox"
                    name="declaracao_elegibilidade"
                    value="Sim"
                    id="de"
                    required
                  />
                  <label class="form-check-label" for="de"
                    >Confirmo que tenho mais de 35 anos de idade.
                    <span class="text-danger">*</span></label
                  >
                </div>
                <div class="form-check">
                  <input
                    class="form-check-input"
                    type="checkbox"
                    name="declaracao_residencia"
                    value="Sim"
                    id="dr"
                    required
                  />
                  <label class="form-check-label" for="dr"
                    >Confirmo que resido nos EUA há pelo menos 14 anos.
                    <span class="text-danger">*</span></label
                  >
                </div>
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold"
                  >Candidato a vice-presidente</label
                >
                <input
                  type="text"
                  class="form-control"
                  name="vice_presidente"
                  placeholder="Nome completo do seu vice"
                />
              </div>
              <div class="col-12">
                <label class="form-label fw-semibold"
                ...
                <textarea
                  ...
                  name="observacoes"
                  rows="3"
                  placeholder="Qualquer informação complementar..."
                ></textarea>
              </div>
            </div>
          </div>
